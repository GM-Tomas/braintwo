...
export function DashboardView() {
  ...
  const handleGenerateReport = () => {
    ...
    setTimeout(() => {
      ...
      const randomReports = [
        '**Resumen de Patrones:** Has registrado principalmente reflexiones personales sobre desarrollo de producto y experiencia de usuario. Tu mayor pico de actividad es por la tarde (12:00 - 18:00). Las palabras clave mas recurrentes son *producto*, *usuario*, y *diseno*. Te recomendamos repasar los audios de notas de voz, que contienen ideas clave aun no transcritas.',
        '**Resumen de Patrones:** Tus mensajes indican un enfoque constante en la organizacion de tareas semanales y notas de estudio. Utilizas el chat de WhatsApp como un bloc de notas rapido, mayormente por la noche (18:00 - 00:00). Hay 3 enlaces guardados esta semana que podrian beneficiarse de un analisis semantico en el Chat IA.',
        '**Resumen de Patrones:** La actividad de esta semana muestra un balance equilibrado entre recordatorios rapidos de tareas y notas teoricas mas extensas. Has guardado un 20% mas de contenido que la semana pasada. La mayoria de las interacciones son en tiempo real durante las mananas.'
      ]
            ...
            <div className="flex flex-col rounded-[14px] border border-bt-border bg-bt-surf p-5">
              ...
              <div className="mt-4 flex flex-col gap-3">
                <button
                  ...
                  className="flex w-full h-9 items-center justify-between rounded-[8px] border border-bt-primary/20 bg-bt-primary/[0.03] px-3.5 text-left text-xs font-medium text-bt-primary transition-all hover:bg-bt-primary/10 hover:text-white disabled:opacity-50"
                >
