...
class InstallBot {
     ...
     */
    constructor({ botRepository, fileRepository, commandRunner, messagePort, logger }) {
     ...
     */
    async execute(botName, zipFilePath, defaultPythonPath) {
        ...
        try {
            ...
            this.messagePort.sendProgress(botName, "Instalando", "Copiando archivo ZIP localmente...", 5);
            this.fileRepository.copyFile(zipFilePath, tempZipPath);

            // 4. Unzip Files
            currentStep = 'Descomprimir ZIP';
            log.step(`Descomprimiendo en: ${botPath}`);
            this.messagePort.sendProgress(botName, "Instalando", "Descomprimiendo archivos...", 10);
            ...
            this.messagePort.sendProgress(botName, "Instalando", "Creando entorno virtual...", 30);
            ...
            if (reqPath) {
                ...
                this.messagePort.sendProgress(botName, "Instalando", "Instalando dependencias de Python...", 60);
            ...
            this.messagePort.sendSuccess(botName, `${botName} instalado exitosamente.`);
            ...
            this.messagePort.sendError(botName, `Error durante la instalación: ${e.message}`);
        }
    }
}
