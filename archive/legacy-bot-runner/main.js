...
const runBotUseCase = new RunBot({ botRepository, commandRunner, fileRepository, logger: brainTwoLogger });
const installBotUseCase = new InstallBot({ botRepository, fileRepository, commandRunner, logger: brainTwoLogger });
